...
class _RegisterUserScreenState extends State<RegisterUserScreen> {
  ...
  validateForm() async{
    ...
    final registerUserViewModel = Provider.of<RegisterUserViewModel>(context,listen: false);

    if(!_formKey.currentState!.validate()){
      return;
    }else if(registerUserViewModel.image.isEmpty || registerUserViewModel.extension.isEmpty){
          ...
          Container(
            ...
            child: Form(
              ...
              child: Column(children: [
                ...
                Consumer<RegisterUserViewModel>(builder: (ctx,imagePicker,neverBuildChild){
                  return Stack(
                    children: [
                      GestureDetector(
                        onTap: (){
                        ...
                        child: Container(
                          ...
                          child: imagePicker.imagePath.isEmpty? Icon(FontAwesomeIcons.building,
                ...
                TextFieldForAll(errorGetter: ErrorGetter().firstNameErrorGetter,hintText: 'First Name', prefixIcon: const Icon(
                ...
                TextFieldForAll(errorGetter: ErrorGetter().lastNameErrorGetter,hintText: 'Last Name', prefixIcon:  const Icon(
                  FontAwesomeIcons.userAlt,
                  color: Color(0xFF019aff),
                  size: 20.0,
                ...
                TextFieldForAll(errorGetter: ErrorGetter().phoneNumberErrorGetter,hintText: 'Phone Number', prefixIcon: const Icon(
                ...
                Consumer<RegisterUserViewModel>(builder: (ctx,registerUserViewModel,neverBuildChild){
                  return  TextFormIconWidget(errorGetter: ErrorGetter().passwordErrorGetter,textEditingController: passwordController,obscureText: registerUserViewModel.obscurePassword, hint: 'Password', prefixIcon: const Icon(FontAwesomeIcons.qrcode,
                      color: Color(0xFF019aff), size: 20.0),onPress: registerUserViewModel.toggleObscure,);
                }),
                const SizedBox(
                  height: 10,
                ),
                ...
                Row(
                  children: [
                    Row(
                      children: [
                        Consumer<RegisterUserViewModel>(builder: (ctx,userRegisterViewModel,neverBuildChild){
                          return Checkbox(
                            // checkColor: Colors.white,
                            // fillColor: MaterialStateProperty.resolveWith(getColor),
                            value: userRegisterViewModel.isCheckedTermsAndCondition,
                            onChanged: (bool? value) {
                            userRegisterViewModel.toggleTermsAndCondition();
                            },
                          );
                        }),
                        Row(
