...
class GetLocationViewModel with ChangeNotifier{
  ...
  Future<LatLng?> getCurrentLocation(BuildContext context)async{
    ...
    if(permission){
      ...
      final registrationCompanyProvider = Provider.of<RegisterCompanyViewModel>(context,listen: false);

      if(latLng!=null){
        registrationCompanyProvider.body['longitude'] = latLng!.longitude.toString();
