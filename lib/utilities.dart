...
class Utilities {
  ...
  Future<Map<String, String>?> setTimer(BuildContext context) async {
    try {
      TimeRange result =
          await showTimeRangePicker(context: context, use24HourFormat: false,);
  ...
  Future<void> showAlertDialog(String title, String subTitle,
  ...
  Map<String,dynamic> response (int code,bool status,String message){
     return {
       'status' :status,
       'code' : code,
       'message' : message
