    ...
    return Scaffold(
      ...
      body: GoogleMap(
        initialCameraPosition:
            CameraPosition(target: locationViewModelProvider.myCurrentLocation.placeLocation, zoom: 9),
        zoomControlsEnabled: false,
        myLocationButtonEnabled: false,
        onMapCreated: (controller) {
          _googleMapController = controller;
          _addMarker(locationViewModelProvider.myCurrentLocation.placeLocation);
        },
