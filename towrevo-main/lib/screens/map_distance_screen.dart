      ...
      appBar: AppBar(backgroundColor: Colors.red,actions: [
        TextButton(onPressed: (){
          _googleMapController!.animateCamera(CameraUpdate.newCameraPosition(
            CameraPosition(target: _origin!.position,tilt: 50.0,zoom:  14.5)
          ));
        }, child: Text('ORIGIN'),style: TextButton.styleFrom(primary:  Colors.blue,textStyle: const TextStyle(fontWeight: FontWeight.w600),),),
        TextButton(onPressed: (){
           _googleMapController!.animateCamera(CameraUpdate.newCameraPosition(
            CameraPosition(target: _destination!.position,tilt: 50.0,zoom:  14.5)
          ));
        }, child: Text('DESTINATION'),style: TextButton.styleFrom(primary:  Colors.green,textStyle: const TextStyle(fontWeight: FontWeight.w600),),),
      ],),
      body: GoogleMap(
        ...
        onMapCreated: (controller) {
          ...
          _setMarker(originPos: locationViewModelProvider.latLng!,destPos: destLatLng);
        },
        markers: {
